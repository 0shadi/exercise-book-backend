...
public class CustomizedBookDetailsEntity {
    ...
    public CustomizedBookDetailsEntity(long id, long orderId, byte[] coverPhoto, String material, String paperColor, String size, String pagesCount, String paperType, String paperQuality, String quantity, LocalDate expectedDate) {
        this.id = id;
